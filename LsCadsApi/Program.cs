using LsCadsApi.Example.Endpoints;
using LsCadsApi.Example.Services;
using LsCadsApi.Utils;
using LsCadsApi.Utils.Http;
using LsCadsApi.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsCadsApi.Config;
using LsCadsApi.Utils.Logging;
using Serilog;
